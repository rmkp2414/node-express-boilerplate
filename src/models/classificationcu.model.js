...
const classificationCUSchema = mongoose.Schema(
  {
    code: {
      type: String,
      required: true,
 ...
 */
 ...
 classificationCuSchema.statics.findByBoreholeName = async function (boreholename) {
 ...
 * @typedef User
 */
const SoilType = mongoose.model('SoilType', classificationCuSchema);
